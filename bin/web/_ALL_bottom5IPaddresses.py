...
html_table = "<!DOCTYPE html><html><head><title>Webhoneypot.json All Time: Bottom 5 Source IP Addresses</title></head><body>"
html_table += "<h1 style='text-align: left; font-family: Verdana;'>Webhoneypot.json All Time: Bottom 5 Source IP Addresses</h1>"
...
file_path = "/var/www/html/bottom5IPaddressesAll.html"
