...
# Query to fetch the bottom three source IP addresses per sensor
query = """
...
html_table = "<!DOCTYPE html><html><head><title>Webhoneypot.json Daily: Bottom 5 Source IP Addresses</title><style>body {background: url('images/blueCamo.jpg') no-repeat center center fixed;background-size: cover;</style></head><body>"
html_table += "<h1 style='text-align: left; font-family: Verdana;color: white;'>Webhoneypot.json Daily: Bottom 5 Source IP Addresses</h1>"
...
file_path = "/var/www/html/bottom5IPaddresses.html"
